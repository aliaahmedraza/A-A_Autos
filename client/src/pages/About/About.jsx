        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12">
            ...
            <p className="mt-4 text-lg text-gray-600">
              At Bike Service & Spare Parts Management System, we aim to
              simplify bike maintenance by providing a seamless, transparent,
              and hassle-free experience. We combine cutting-edge technology
              with exceptional customer service to ensure your bike gets the
              care it deserves.
            </p>
          </div>
          ...
          <div className="mt-12">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="mt-2 text-gray-600">
                  Live updates, photo/video proofs, and upfront cost estimates
          ...
          <div className="mt-12">
            ...
            <p className="mt-4 text-lg text-gray-600">
              ...
              safe hands. Our post-service support ensures you’re always
